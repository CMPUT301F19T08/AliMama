...
//            super(itemView);
//            pic = (ImageView)itemView.findViewById(R.id.imageV);
...
//    public void contactAdapter(ArrayList<Contact> contactList) {
...
//                .inflate(R.layout.card_contact_page, parent, false);
